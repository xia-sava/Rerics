...
DESKTOP_NAME = "rerics-offscreen"
GENERIC_ALL = 0x10000000
STARTF_USESTDHANDLES = 0x00000100
CREATE_SUSPENDED = 0x00000004
TIMEOUT_MS = int(os.environ.get("RUNDESK_TIMEOUT_MS") or 15 * 60 * 1000)
...
# 64bit でハンドルを返すものは restype を指定する。既定の c_int だと上位が落ちる。
...
def main(argv):
    ...
    if rc != 0:
        sys.stderr.write("rundesk: 時間切れで打ち切った（%d ms）\n" % TIMEOUT_MS)
