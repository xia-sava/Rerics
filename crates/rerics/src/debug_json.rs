...
pub fn pane_state_json(state: &FileListState, chrome: &PaneChrome) -> Value {
    ...
    json!({
        ...
        "search": {
            ...
            "case_sensitive": state.search.opts.case_sensitive,
            "whole_word": state.search.opts.whole_word,
            "regex": state.search.opts.regex,
            "filter": state.search.filter,
            "filtering": state.search.filtering(),
            "hidden_count": state.search.hidden_count(),
        },
