...
pub use config::{
    Bookmark, Config, DEFAULT_CONFIG_TOML, FontSpec, ImageSettings, InputHistory, Layout,
    PATH_HISTORY_CAP, PATH_HISTORY_KEY, ResolvedTheme, State, TabState, Theme, ThemeColors,
